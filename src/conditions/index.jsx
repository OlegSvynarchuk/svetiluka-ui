        ...
        return (
            ...
            {this.state.serverError && <Error />}
                ...
                <div className='order-icon-section'>
                    ...
                    деталье коjи жельите да буду променьене у икони. Ако нисте пронашли
                    одговараjучу икону у каталогу напишите нама на мейл <span>svetiluka@info.com </span> 
                    коjу икону желели би да наручите или попуните форму испод. Ако имате
                    слику можете прикачити ньу и послати заjедно са формом. 
                    </p>
                    ...
                    <label htmlFor='file'>Пошалите фотографиjу иконе</label>
                        <input id='file'
                ...
                <label htmlFor='message'>Порука</label>
                    ...
                    <div className='payment-conditions-section'>
                        <h3>Израда</h3>
                    <p>
                    Израда иконе може траjати од 5 до 15 дана
                    у зависности од димензиjе и компликованости 
                        композициjе.
                    </p>
                        <h3>Плачанье</h3>
                    <p>
                    Све иконе плачаjусе поузечем након испоруке
                    ...
                    Иконе можете да платите у еврима или у динарском еквиваленту.
                        ...
                        <h3>Достава</h3>
                    <p>
                    Све иконе испоручуюсе путем доставе курирском службом. 
